...
def __get_message(message: str, indent_level: int = 1):
    if indent_level < 1:
        indent_level = 1
...
def debug(message: str, indent_level: int = 0):
    logging.debug(__get_message(message, indent_level))


def info(message: str, indent_level: int = 0):
    logging.info(__get_message(message, indent_level))


def warning(message: str, indent_level: int = 0):
    logging.warning(__get_message(message, indent_level))


def error(message: str, indent_level: int = 0):
    logging.error(__get_message(message, indent_level))


def exception(message: str, indent_level: int = 0):
    logging.exception(__get_message(message, indent_level))


def critical(message: str, indent_level: int = 0):
